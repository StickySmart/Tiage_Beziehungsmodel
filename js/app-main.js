 ...
 */
        ...
        // ═══════════════════════════════════════════════════════════════════════════
        // BEDÜRFNIS-DEFINITIONEN: Gelöscht v1.8.985 - Daten aus window.BeduerfnisKatalog
        // ═══════════════════════════════════════════════════════════════════════════
        ...
        // NOTE: closeGfkExplanationModal -> now in js/dimensions/gfkMatching.js
...
var FLAT_NEED_SAVE_DEBOUNCE_MS = 500;
        ...
        // NOTE: openGfkExplanationModal, openPaarungExplanationModal, closePaarungExplanationModal
        // -> now in js/modals/explanationModals.js (TiageExplanationModals)
        ...
        function filterProfileReviewByNeed(query) {
            ...
            if (isFlatView) {
                ...
                var hauptfrageItems = contentContainer.querySelectorAll('.flat-need-item.is-hauptfrage');
                hauptfrageItems.forEach(function(hauptfrageItem) {
                    var hauptfrageId = hauptfrageItem.getAttribute('data-need') || '';
                    var hauptfrageLabel = hauptfrageItem.querySelector('.flat-need-label');
