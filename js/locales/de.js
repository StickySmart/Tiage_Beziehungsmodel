...
var TiageLocale_DE = {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // BEDÜRFNIS-KATALOG (16 Grundbedürfnisse + 4 Entwicklungsstufen)
    // ═══════════════════════════════════════════════════════════════════════

    beduerfnisKatalog: {
        heading: 'Entwicklungsstufen',
        stufen: {
            S1: { label: 'Fundament',     short: 'Fund.', desc: 'Existenz · Sicherheit · Ruhe · Alltag' },
            S2: { label: 'Entfaltung',    short: 'Entf.', desc: 'Freiheit · Ausdruck · Kink · Kommunikation' },
            S3: { label: 'Verbundenheit', short: 'Verb.', desc: 'Zuneigung · Intimität · Werte · Soziales' },
            S4: { label: 'Sinn',          short: 'Sinn',  desc: 'Identität · Lebensplanung · Transformation' }
        },
        highStrength: 'Hohe Bedürfnisstärke in dieser Stufe',
        mediumStrength: 'Mittlere Bedürfnisstärke',
        lowStrength: 'Niedrige Bedürfnisstärke in dieser Stufe',
        avgLabel: 'Euer Ø',
        stufeLabel: 'Stufe',
        kernthemaLabel: 'Kernthema',
        charakteristikLabel: 'Charakteristische Bedürfnisse dieser Stufe',
        beziehungLabel: 'In eurer Beziehung',
        eureBeduerfnisseLabel: 'Eure Bedürfnisse auf dieser Stufe',
        meineStaerkeLabel: 'Meine Stärke',
        resonanzLabel: 'Resonanz',
        geteiltLabel: 'geteilt',
        needs: {
            ...
            sinn:             'Sinn',
            integritaet:      'Integrität',
            selbstentfaltung: 'Selbstentfaltung'
        },
        stufeInfo: {
            1: {
                titel: 'Fundament',
                ...
                charakteristik: [
                    { sub: 'Unversehrtheit, Gesundheit, Fitness, Erholung' },
                    { sub: 'Zuversicht, Stabilität, Schutz, Halt, Loyalität' },
                    { sub: 'Energieeinsparung, Einfachheit, Harmonie' },
                    { sub: 'Klarheit, Struktur, Ordnung, Führung, Kontrolle' }
                ],
            ...
            2: {
                ...
                charakteristik: [
                    { sub: 'Handlungsfähigkeit, Einfluss, Macht, Souveränität' },
                    { sub: 'Autonomie, Selbstbestimmtheit, Unabhängigkeit' },
                    { sub: 'Lebendigkeit, Leidenschaft, Selbst-Erfahrung, Sinnlichkeit' },
                    { sub: 'Wachstum, Entfaltung, Lernen' }
                ],
            ...
            3: {
                ...
                charakteristik: [
                    { sub: 'Gesellschaft, Zugehörigkeit, Familie, Clan' },
                    { sub: 'Wertschätzung, Respekt, Bedeutung, Nützlichkeit' },
                    { sub: 'Fairness, Angemessenheit, Gleichwertigkeit' },
                    { sub: 'Intimität, Geborgenheit, Nähe, Vertrauen' }
                ],
            ...
            4: {
                ...
                charakteristik: [
                    { sub: 'Bewusstheit, Integration, Weisheit' },
                    { sub: 'Berufung, Vision, Mission' },
                    { sub: 'Wahrhaftigkeit, Konsistenz, Authentizität, Würde' },
                    { sub: 'Selbstwerdung, Selbstverwirklichung, Flow' }
                ],
    ...
    synthese: {
        ...
        // ── Übersicht-Seite ────────────────────────────────────────────────
        top5Title: 'Top-5 Bedürfnisse',
        top5Subtitle: 'Klicke bis zu 5 mal das Bild um mehr zu erfahren',
        breakdownSubtitle: 'Bedürfnis-Aufschlüsselung',
        evolutionTitle: 'Evolutionäre Bedürfnisstärke',
        evolutionSubtitleBoth: 'ICH × PARTNER — Resonanz nach Entwicklungsstufen',
        evolutionSubtitleIch: 'ICH — Resonanz nach Entwicklungsstufen',
        viewBild: '📷 Bild', viewWeisheit: '📖 Weisheit', viewTradition: '🕊 Traditionen',
        viewKarte: '🃏 Bedürfniskarte', viewModif: '🔢 GAD G/A/D FFH',
        modifSectionTitle: '🔢 GAD G/A/D FFH · Modifikatoren',
        archetypbasis: 'Archetypbasis', finalLabel: 'Final', manualSurvey: 'Manuell / Umfrage',
        modGeschlecht: 'Geschlecht', modAttraktion: 'Attraktion', modDominanz: 'Dominanz',
        modOrientierung: 'Orientierung', modArchetyp: 'Archetyp',
        loadingKatalog: 'Lade Bedürfnis-Katalog...', loadingWisdom: '🧬 Lade Tiage-Weisheit…',
        noImage: 'Kein Bild verfügbar', noWisdom: 'Kein Weisheitstext verfügbar',
        noTraditions: 'Keine Traditionsquellen verfügbar', noTextAvailable: 'Kein Text verfügbar.',
        loadError: 'Texte konnten nicht geladen werden.',
        noNeedsSaved: 'Keine Bedürfnisse gespeichert.',
        noNeedsSavedHint: 'Bitte auf der Hauptseite Bedürfnisse einstellen.',
        noModifiersActive: 'Keine Modifikatoren aktiv.',
        noModifiersHint: 'Geschlecht / Dominanz / Orientierung auf der Hauptseite einstellen.',
        reflexionLabel: '💡 Reflexion', standardBtn: '✓ Standard',
        imageSavedToast: 'Bild als Standard gespeichert ✓',
        setDefaultImgTitle: 'Als Standard-Bild für dieses Bedürfnis setzen',
        recalcToast: '↻ Neuberechnung nach Bedürfnis-Änderung',
        zoomHint: 'zum Vergrößern klicken', nextViewTitle: 'Nächste Ansicht',
        closeBtnTitle: 'Schließen', prevImgTitle: 'Vorherige', nextImgTitle: 'Nächste',
        clickWisdomTitle: 'Klick: Tiage-Weisheit anzeigen',
        bestResonanceTitle: 'Beste gemeinsame Resonanz',
        biggestDiffTitle: 'Größte Differenz zum Partner',
        imagePrefSaved: 'Standard-Bild gespeichert',
        notInTop5Title: 'Nicht in euren gemeinsamen Top-5',
        complementaryTitle: 'Komplementär — nicht gemeinsam',
        complementaryDom: 'Komplementäre Dynamik: Dominant braucht dieses Bedürfnis stark — Submissiv gibt es bewusst ab. Das ergänzt sich.',
        complementarySub: 'Komplementäre Dynamik: Submissiv braucht dieses Bedürfnis stark — Dominant füllt es aus. Das ergänzt sich.',
        deltaHighIch: 'Dein Spitzenwert wird durch die Differenz neutralisiert — Resonanz braucht ähnliche Stärke bei beiden.',
        deltaHighPartner: 'Dein Partner priorisiert das stärker als du — die Differenz ist zu groß für echte Übereinstimmung.',
        bothTooLow: 'Beide priorisieren dieses Bedürfnis zu gering für die gemeinsamen Top-5.',
        tooDifferent: 'Die Werte sind zu unterschiedlich für eine echte gemeinsame Priorität.',
        matrixHeaderFactor: 'R-Faktor → AGOD', matrixColKombi: 'ICH × PARTNER',
        matrixClickTooltip: 'Klicken um ICH/{label} in Einstellungen zu öffnen',
        breakdownInfo: '{n} Bedürfnisse durch G/A/D{ffh}{manual} angepasst · Klick auf Name für Details',
        breakdownColNeed: 'Bedürfnis', breakdownColStufe: 'Stufe',
        breakdownColBasis: 'Basis', breakdownColFinal: 'Final',
        breakdownDetailTitle: 'Details zu: {label}',
        breakdownManualTooltip: 'Manuelle Slider-Abweichung von der automatischen Berechnung',
        mobileTitle: 'PC empfohlen',
        mobileText1: 'Diese App ist für die Nutzung am Computer optimiert.',
        mobileText2: 'Auf dem Handy funktioniert nicht jede Ansicht einwandfrei.',
        mobileContinue: 'Trotzdem fortfahren',
        tradChristentum: 'Christentum', tradBuddhismus: 'Buddhismus',
        tradIslam: 'Islam / Sufismus', tradOsho: 'Osho',
        tradModerne: 'Moderne', tradPirsig: 'Pirsig · Qualität',
        // ── Weitere Seiten-Übersetzungen ──────────────────────────────────
        oshoModuleHint: 'Bitte stelle sicher, dass oshoZenTextGenerator.js geladen ist.',
        loadingKatalogShort: 'Lade Katalog...',
        noNeedsInStufe: 'Keine Bedürfnisse in dieser Stufe gefunden',
        stufenSubtitleBoth: 'ICH × PARTNER — Ø-Bedürfnisstärke je Stufe (0–100)',
        stufenSubtitleIch: 'DU — Bedürfnisstärke je Stufe (0–100)',
        rtiVerbindung: 'RTI-Verbindung',
        staerksteBeduerfnisse: 'Stärkste Bedürfnisse · {name}',
        deltaVeryHigh: 'stark überdurchschnittlich', deltaHigh: 'überdurchschnittlich',
        deltaVeryLow: 'stark unterdurchschnittlich', deltaLow: 'unterdurchschnittlich',
        deltaNormal: 'entspricht Archetyp-Norm',
        sourceManual: '🔒 Von dir manuell gesetzt',
        sourceCalculated: '📐 Aus Profil berechnet&#10;   ({name} + G · D · O · FFH · RTI)',
        viewWisheitHeader: '📖 Ti-Age Weisheit', viewTraditionHeader: '🕊 Weisheitstraditionen',
        noTraditionsAvail: 'Keine Traditionen verfügbar',
        stufenDesc: { S1: 'Existenz · Sicherheit · Ruhe · Alltag', S2: 'Freiheit · Ausdruck · Kink · Kommunikation', S3: 'Zuneigung · Intimität · Werte · Soziales', S4: 'Verständnis · Identität · Lebensplanung · Spiritualität' },
        stufenRtiDesc: { S1: 'Basiert auf Sicherheit & Struktur (S4)', S2: 'Gespeist von Leiblichkeit (S1) und Autonomie (S3)', S3: 'Geprägt durch das Soziale Netz (S2)', S4: 'Getragen von Werte & Sinn (S5) und Autonomie (S3)' },
        perspektivenTitle: 'Perspektiven & Pro/Contra', perspektivenSubtitle: 'Partner-Vergleich',
        perspektivenGewichtung: 'Perspektiven-Gewichtung',
        perspektivenBlickwinkel: 'Philosophische Blickwinkel auf Bedürfnisse',
        kopfHerzBalance: 'Kopf-Herz-Balance', theorieVsPraxis: 'Theorie vs. Praxis',
        manuelleAenderungen: '{n} manuelle Änderungen',
        diskrepanz: 'Diskrepanz', einklang: 'Einklang',
        theorie: 'Theorie', praxis: 'Praxis',
        automatischeBerechnung: 'Automatische Berechnung',
        mitManuellenAenderungen: 'Mit manuellen Änderungen',
        proContraTitle: 'Pro & Contra', proContraPaarung: 'Paarung',
        balanceInterpLocked0: 'Keine manuellen Änderungen - Theorie = Praxis',
        balanceInterpVeryClose: 'Manuelle Anpassungen bestätigen die Theorie',
        balanceInterpClose: 'Geringe Abweichung durch manuelle Anpassungen',
        balanceInterpModerate: 'Moderate Abweichung zwischen Theorie und Praxis',
        balanceInterpHigh: 'Deutliche Diskrepanz - Praxis weicht stark von Theorie ab',
        balanceInterpNeutral: 'Manuelle Anpassungen weichen etwas von der Theorie ab',
        fallbackProCanLearn: '{ich} und {partner} können voneinander lernen',
        fallbackProEnriching: 'Unterschiedliche Perspektiven bereichern die Beziehung',
        fallbackProGrowth: 'Potenzial für gegenseitiges Wachstum',
        fallbackContraCommunication: 'Unterschiedliche Beziehungsphilosophien erfordern Kommunikation',
        fallbackContraExpectations: 'Erwartungsmanagement notwendig',
        fallbackContraCompromise: 'Kompromissbereitschaft auf beiden Seiten erforderlich',
        ichProfileNotLoaded: 'ICH-Profil nicht geladen',
        ichProfileNotLoadedHint: 'Bitte stellen Sie sicher, dass das ICH-Profil vollständig ausgefüllt ist.',
        hauptfragen: 'Ti-Age Hauptfragen', deineBeduerfnisse: 'Deine Bedürfnisse (ICH)',
        hauptfragenSubtitle: 'Resonanz → Kategorien → Nuancen',
        beduerfnisMatch: 'Bedürfnis-Übereinstimmung',
        rtiSectionTitle: 'RTI Säulen der Identität', rtiSectionSubtitle: 'Nach Hilarion Petzold',
        rtiInfoTitle: 'ℹ️ Was zeigt diese Auswertung?',
        rtiInfoText: 'Die 5 Säulen zeigen, wie eure Bedürfnisse in den wichtigsten Lebensbereichen übereinstimmen. Die Balken vergleichen deine Werte (ICH) mit denen deines Partners.',
        rtiInfoHighLabel: 'Hohe Resonanz', rtiInfoHighMeaning: 'Eure Werte sind ähnlich',
        rtiInfoLowLabel: 'Niedrige Resonanz', rtiInfoLowMeaning: 'Hier könnt ihr voneinander lernen',
        resonanzLabel: 'Resonanz',
        resonanzHoch: 'Hohe Resonanz', resonanzMittel: 'Mittlere Resonanz', resonanzNiedrig: 'Niedrige Resonanz',
        differenzPct: '{n}% Differenz', rtiModalTitle: 'RTI Säulen',
        rtiPillars: {
            S1: { name: 'Leiblichkeit', question: 'Wie wichtig ist körperliche Nähe in eurer Beziehung?', desc: 'Körperliche Gesundheit, Wohlbefinden, Sexualität, Bewegung. Wie wohl fühle ich mich in meinem Körper?', interpHigh: 'Ihr teilt ein starkes Bedürfnis nach körperlicher Verbindung.', interpMedium: 'Eure Vorstellungen von körperlicher Nähe unterscheiden sich teilweise.', interpLow: 'Hier besteht Gesprächsbedarf – eure Bedürfnisse sind unterschiedlich.' },
            S2: { name: 'Soziales Netzwerk', question: 'Wie wichtig ist euch die Einbindung in ein soziales Umfeld?', desc: 'Familie, Freunde, Kollegen, Gemeinschaft. Wie gut bin ich sozial eingebunden und unterstützt?', interpHigh: 'Ihr schätzt beide ein starkes soziales Netzwerk.', interpMedium: 'Eure Vorstellungen von sozialer Einbindung variieren.', interpLow: 'Unterschiedliche Erwartungen an soziale Integration.' },
            S3: { name: 'Autonomie & Leistung', question: 'Wie viel persönlicher Freiraum ist euch wichtig?', desc: 'Arbeit, Beruf, Erfolg, Selbstwirksamkeit. Wie selbstbestimmt und kompetent fühle ich mich?', interpHigh: 'Ihr respektiert beide den persönlichen Freiraum des anderen.', interpMedium: 'Die Balance zwischen Nähe und Autonomie ist ein Thema.', interpLow: 'Unterschiedliche Bedürfnisse nach Eigenständigkeit.' },
            S4: { name: 'Sicherheit & Stabilität', question: 'Wie wichtig sind Verlässlichkeit und Stabilität?', desc: 'Materielle Absicherung, Wohnen, Finanzen, Zukunftsplanung. Wie sicher fühle ich mich?', interpHigh: 'Stabilität und Verlässlichkeit sind für euch beide wichtig.', interpMedium: 'Eure Sicherheitsbedürfnisse sind unterschiedlich gewichtet.', interpLow: 'Hier solltet ihr über eure Erwartungen sprechen.' },
            S5: { name: 'Werte & Sinn', question: 'Teilt ihr gemeinsame Werte und Lebensziele?', desc: 'Spiritualität, Ethik, Lebenssinn, Weltanschauung. Was gibt meinem Leben Bedeutung?', interpHigh: 'Eure Grundwerte und Lebensziele sind kompatibel.', interpMedium: 'In einigen Bereichen unterscheiden sich eure Überzeugungen.', interpLow: 'Unterschiedliche Wertvorstellungen erfordern Verständnis.' }
        },
        rtiPillarInfo: {
            general: '<p>Die fünf Säulen bilden die Grundbedürfnisse ab, die in Beziehungen eine Rolle spielen. Sie basieren auf psychologischen Modellen und machen sichtbar, wo deine Prioritäten liegen.</p><p><strong>0 = Egal</strong> – dieses Thema spielt für dich keine große Rolle<br><strong>1 = Normal</strong> – ein Grundbedürfnis, aber nicht im Fokus<br><strong>2 = Wichtig</strong> – hier liegt dein Schwerpunkt</p><p>Es gibt kein "richtig" oder "falsch". Die Säulen zeigen, was dir wichtig ist – nicht was wichtig sein sollte.</p>',
            S1: { text: '<p>Körperliche Nähe, Berührung, Sexualität. Wie wichtig ist dir der körperliche Ausdruck von Verbindung?</p><p>Das umfasst: körperliche Präsenz, Zärtlichkeit, sexuelle Intimität, gemeinsames Erleben durch den Körper.</p>', quote: 'Pirsig würde sagen: Qualität zeigt sich zuerst im Spüren, bevor sie gedacht wird.' },
            S2: { text: '<p>Einbindung in ein größeres Ganzes. Freunde, Familie, Community. Wie wichtig ist es dir, dass deine Beziehung in ein soziales Umfeld eingebettet ist?</p><p>Das umfasst: gemeinsame Freunde, Familienintegration, öffentliche Sichtbarkeit der Beziehung, Teil einer Gemeinschaft sein.</p>', quote: null },
            S3: { text: '<p>Eigenständigkeit und persönlicher Freiraum. Wie wichtig ist es dir, in einer Beziehung du selbst zu bleiben?</p><p>Das umfasst: eigene Zeit, eigene Interessen, eigene Entscheidungen, Raum für persönliche Entwicklung.</p>', quote: 'Osho sagt: Zwei ganze Menschen können sich begegnen. Zwei Hälften suchen nur Ergänzung.' },
            S4: { text: '<p>Stabilität, Verlässlichkeit, Vertrauen. Wie wichtig ist dir das Gefühl, dich auf die Beziehung verlassen zu können?</p><p>Das umfasst: emotionale Sicherheit, Verbindlichkeit, Beständigkeit, klare Absprachen.</p>', quote: null },
            S5: { text: '<p>Gemeinsame Überzeugungen und Lebensziele. Wie wichtig ist es dir, dass ihr in grundlegenden Fragen übereinstimmt?</p><p>Das umfasst: Weltanschauung, Lebensentwurf, ethische Grundsätze, spirituelle oder philosophische Ausrichtung.</p>', quote: 'Tiage-Perspektive: Resonanz entsteht nicht nur durch Gefühl, sondern auch durch gemeinsame Richtung.' }
        }
    },
