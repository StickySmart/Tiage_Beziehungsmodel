...
var TiageLocale_IT = {
    ...
    ui: {
        ...
        // Stringhe UI mancanti
        noDataAvailable: 'Nessun dato disponibile.',
        noEntriesFound: 'Nessuna voce trovata.',
        needNotFound: 'Bisogno {id} non trovato.',
        noSpecificAdvantages: 'Nessun vantaggio specifico noto',
        noSpecificChallenges: 'Nessuna sfida specifica nota',
        sharedNeeds: 'Bisogni comuni',
        needsComparison: 'Confronto dei bisogni',
        showDefinition: 'Mostra definizione',
        identitySecondary: 'Identità (secondaria)',
        clickForDefinition: 'Clicca per la definizione',
        clickForDerivation: 'Clicca per la derivazione',
        fixedOnSwitch: 'Fisso - conservato al cambio archetipo',
        manuallyLocked: 'Bloccato manualmente (modifica in Attributi)',
        autoCalculated: 'Calcolato automaticamente',
        locked: 'Bloccato',
        removeSearch: 'Rimuovi ricerca',
        removeSelection: 'Rimuovi selezione',
        yourProfileSetting: 'La tua impostazione profilo',
        partnerProfileSetting: 'Impostazione profilo partner',
        yourProfile: 'Il tuo profilo {archetype} ({visible} di {total} bisogni)',
        yourProfileAll: 'Il tuo profilo {archetype} ({total} bisogni)',
        missingSelection: 'Selezione mancante',
        replyTo: 'Rispondi a {name}...',
        archetypeBaseValues: 'Valori base archetipo',
        archetypeBaseValuesDesc: 'Valori individualizzati non disponibili. Vengono mostrati i valori standard dell\'archetipo.'
    },
    ...
    warnings: {
        noAttraction: 'Nessuna attrazione emotiva/fisica:',
        noAttractionDesc: 'L\'incompatibilità di orientamento impedisce una relazione romantica',
        uncertainAttraction: 'Attrazione fisica incerta (fase di esplorazione)',
        uncertainDominance: 'Dinamica di dominanza incerta (fase di esplorazione – confidenza ridotta)',
        philosophyWarning: 'Avviso livello razionale: Filosofia solo {score}',
        noNeedsData: 'Nessun dato sui bisogni',
        noNeedsDataDesc: 'I fattori di risonanza R1-R3 non possono essere calcolati. Regola i valori dei bisogni nel profilo.',
        fundamentalDifferences: 'Avviso livello razionale: Differenze filosofiche fondamentali',
        differentApproaches: 'Nota livello razionale: Approcci filosofici diversi',
        relationshipPhilosophy: 'Filosofia relazionale: {score}',
        warningText: 'Le vostre convinzioni fondamentali sulle relazioni sono molto diverse. Ciò richiede comunicazione intensa e disponibilità al compromesso.',
        infoText: 'Avete idee diverse sulle relazioni. La comunicazione aperta è importante.',
        pathosLogosTitle: 'Pathos vs. Logos',
        emotionLevel: 'LIVELLO EMOTIVO (Emozione/Corpo)',
        emotionDesc: 'Attrazione fisica ed emotiva',
        emotionDimension: 'Orientamento sessuale',
        emotionImmutable: 'Non modificabile attraverso apprendimento o comunicazione',
        emotionConsequence: 'Senza livello emotivo: Nessuna relazione romantica possibile',
        reasonLevel: 'LIVELLO RAZIONALE (Filosofia/Convinzioni)',
        reasonDesc: 'Filosofia relazionale e convinzioni razionali',
        reasonDimension: 'Convinzioni e valori',
        reasonMutable: 'Può essere modificato attraverso comunicazione e apprendimento',
        reasonConsequence: 'Senza livello razionale: Relazione difficile, ma possibile',
        pathosLogosQuote: '"Il livello emotivo è il fondamento - senza attrazione fisica non può esistere una relazione romantica. Il livello razionale è il tetto - protegge e struttura, ma può essere ricostruito."'
    },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // COLONNA CENTRALE (Risonanza, Ponderazione, AGOD, Punteggio)
    // ═══════════════════════════════════════════════════════════════════════

    center: {
        resonanzHeading: 'Fattori di risonanza',
        gewichtungHeading: 'Ponderazione',
        gewichtungDesc: '0 = Ignora · 1 = Rilevante · 2 = Importante · 3 = Decisivo',
        agodLabels: {
            A: 'ARCHETIPO',
            G: 'GENERE',
            O: 'ORIENTAMENTO',
        ...
        agodTitles: {
            A: 'Archetipo - Ponderazione',
            G: 'Genere - Ponderazione',
            O: 'Orientamento - Ponderazione',
            D: 'Dominanza - Ponderazione'
        },
        syntheseScoreLabel: 'TI-AGE PUNTEGGIO SINTESI',
        findMatch: 'TROVA PARTNER COMPATIBILE',
        findMatchTitle: 'Trova il partner migliore - testa tutte le 864 combinazioni',
        pleaseSelect: '– Seleziona –',
        noArchetypeSelected: 'Nessun archetipo selezionato',
        resetWeights: 'Predefinito (tutti a 1)',
        openSynthese: 'Apri Ti-Age Sintesi',
        rFactorTitles: {
            R1: 'R1 - Vita (Orientamento)',
            R2: 'R2 - Filosofia (Archetipo)',
            R3: 'R3 - Kink (Dominanza)',
            R4: 'R4 - Identità (Genere)'
        }
    },

    // ═══════════════════════════════════════════════════════════════════════
    // INTESTAZIONE / BARRA VISITATORE
    // ═══════════════════════════════════════════════════════════════════════

    header: {
        visitorBadge: 'Visitatore',
        privacyNotice: 'Anonimo – nessun dato personale',
        privacyTitle: 'Non vengono memorizzati dati personali',
        clearBtn: 'Cancella',
        clearTitle: 'Elimina tutti i dati salvati e ripristina l\'interfaccia'
    },

    // ═══════════════════════════════════════════════════════════════════════
    // ETICHETTE DIMENSIONI + LEGENDE
    // ═══════════════════════════════════════════════════════════════════════
    ...
    dimensionLabels: {
        ...
        dominanz: 'DOMINANZA',
        gfk: 'COMPETENZA CNV',
        primarySecondaryRules: '(P=Primario, S=Secondario - Regole)',
        primarySecondary: '(P=Primario, S=Secondario)',
        gfkAutoDesc: 'La competenza CNV viene calcolata automaticamente in base agli archetipi relazionali selezionati.'
    },
    ...
    mobile: {
        next: 'Avanti →',
        nextToPartner: 'Avanti: Partner →',
        resetSelection: 'Ripristina selezione',
        yourPartner: 'IL TUO PARTNER',
        bestMatchTitle: 'Best Match Finder',
        bestMatchDesc: 'Trova il partner migliore basato sul tuo profilo',
        testsAllCombinations: 'Testa tutte le 864 combinazioni di archetipi',
        selectManually: 'Seleziona partner manualmente →',
        pageTitlePartner: 'Il tuo Partner',
        pageTitleBestMatch: 'Trova Partner',
        syntheseBtn: 'SINTESI'
    },
    ...
    rti: {
        pillars: {
            ...
            S3: 'Autonomia',
            S4: 'Sicurezza',
            S5: 'Valori & Significato'
        },
        clickForDef: 'Clicca per la definizione'
    },
    ...
    modals: {
        resonanzTitle: 'Fattori di risonanza',
        resonanzHelpTitle: 'Fattori di risonanza - Calcolo',
        adjustAttributes: 'Modifica i MIEI attributi',
        commentTitle: 'Invia commento',
        visitorNr: 'Visitatore n.',
        whatDoYouThink: 'Cosa ne pensi?',
        commentPlaceholder: 'Scrivi qui i tuoi pensieri...',
        maxChars: 'Max. 2000 caratteri',
        submit: 'Invia',
        factorDetails: 'Dettagli fattore',
        compatibilityAnalysis: 'Analisi di compatibilità',
        statisticalMatch: 'Corrispondenza statistica degli archetipi',
        definition: 'Definizione',
        beduerfnisseAnpassen: 'Modifica bisogni',
        syntheseTitle: 'Ti-Age Sintesi',
        // Resonanz-Modal
        resonanzHeading: 'Fattori di risonanza (R1-R4)',
        resonanzCoherence: 'Coerenza tra bisogni e archetipo',
        prevArchetype: 'Archetipo precedente',
        nextArchetype: 'Archetipo successivo',
        rFactorAgod: 'R-Fattore → AGOD',
        paarung: 'COPPIA',
        tableWhat: 'Cosa mostra questa tabella?',
        tableIchPartner: 'Coerenza tra bisogni e archetipo scelto.',
        tablePaarung: 'R_IO × R_PARTNER (prodotto dei valori di coerenza individuali).',
        tablePaarungMultiplies: 'Il valore della COPPIA moltiplica il rispettivo punteggio AGOD:',
        legendBoost: '● >1.0 = aumenta il punteggio',
        legendNeutral: '● =1.0 = neutrale',
        legendWeaken: '● <1.0 = indebolisce il punteggio',
        lockManual: '🔒 = bloccato manualmente (non cambia al cambio archetipo)',
        lockAuto: '🔓 = automatico (ricalcolato al cambio archetipo)',
        tipClickValue: '💡 Suggerimento: Clicca su un valore IO o PARTNER per vedere la derivazione completa!'
    },
    ...
    ffh: {
        fit: 'Fit',
        fitDesc: 'Lo sport e la forma fisica sono importanti per te.',
        fuckedup: 'Fucked up',
        fuckedupDesc: 'Hai uno stile di vita non convenzionale o intenso.',
        horny: 'Horny',
        hornyDesc: 'La sessualità ha un ruolo importante nella tua vita.',
        fresh: 'Fresh',
        freshDesc: 'Fresco, libero da pesi, riposato — nuova energia senza zavorra.'
    },
    ...
    toast: {
        locked: 'Valore bloccato e salvato',
        unlocked: 'Valore sbloccato',
        selectAllDimensions: 'Selezionare tutte le dimensioni.',
        noNeedsData: 'Nessun dato sui bisogni disponibile',
        saved: 'Salvato!'
    },
    ...
    needsEditor: {
        pageTitle: 'Editor dei bisogni',
        allNeeds: 'Tutti i bisogni',
        analyzing: '219 bisogni in fase di analisi...',
        backBtn: '← Indietro',
        sortLabel: 'Ordina:',
        sortValue: 'Valore',
        sortName: 'Nome',
    ...
    beduerfnisKatalog: {
        heading: 'Stadi di sviluppo',
        stufen: {
            S1: { label: 'Fondamento',  short: 'Fond.', desc: 'Esistenza · Sicurezza · Riposo · Quotidiano' },
            S2: { label: 'Sviluppo',    short: 'Svil.', desc: 'Libertà · Espressione · Kink · Comunicazione' },
            S3: { label: 'Connessione', short: 'Conn.', desc: 'Affetto · Intimità · Valori · Sociale' },
            S4: { label: 'Senso',       short: 'Senso', desc: 'Identità · Pianificazione di vita · Trasformazione' }
        },
        highStrength: 'Alta intensità del bisogno in questo stadio',
        mediumStrength: 'Media intensità del bisogno',
        lowStrength: 'Bassa intensità del bisogno in questo stadio',
        avgLabel: 'La tua med.',
        stufeLabel: 'Stadio',
        kernthemaLabel: 'Tema centrale',
        charakteristikLabel: 'Bisogni caratteristici di questo stadio',
        beziehungLabel: 'Nella vostra relazione',
        eureBeduerfnisseLabel: 'I vostri bisogni in questo stadio',
        meineStaerkeLabel: 'La mia forza',
        resonanzLabel: 'Risonanza',
        geteiltLabel: 'condiviso',
        needs: {
            wohlbefinden: 'Benessere', sicherheit: 'Sicurezza', leichtigkeit: 'Leggerezza',
            orientierung: 'Orientamento', wirksamkeit: 'Efficacia', freiheit: 'Libertà',
            intensitaet: 'Intensità', entwicklung: 'Sviluppo', gemeinschaft: 'Comunità',
            anerkennung: 'Riconoscimento', gerechtigkeit: 'Giustizia', verbundenheit: 'Connessione',
            selbsterkenntnis: 'Autoconoscenza', sinn: 'Senso', integritaet: 'Integrità',
            selbstentfaltung: 'Autorealizzazione'
        },
        stufeInfo: {
            1: {
                titel: 'Fondamento', evolution: 'Organismi pluricellulari',
                kernthema: 'Sicurezza & Stabilità',
                beschreibung: 'Il primo stadio dello sviluppo psichico è emerso con la vita multicellulare. Garantisce la sopravvivenza attraverso il coordinamento e la protezione. I bisogni a questo livello agiscono in profondità e spesso inconsciamente — la loro mancata soddisfazione crea stress persistente e ritiro.',
                charakteristik: [
                    { sub: 'Integrità, salute, forma fisica, recupero' },
                    { sub: 'Fiducia, stabilità, protezione, lealtà' },
                    { sub: 'Risparmio energetico, semplicità, armonia' },
                    { sub: 'Chiarezza, struttura, ordine, guida, controllo' }
                ],
                beziehung: 'Nelle relazioni, questo stadio si manifesta come desiderio di affidabilità, accordi chiari e sicurezza emotiva. Una carenza a questo livello porta ad ansia, ritiro o controllo eccessivo.',
                frage: 'Dove ti senti davvero al sicuro — e dove no?'
            },
            2: {
                titel: 'Sviluppo', evolution: 'Vita animale',
                kernthema: 'Forza & Autoespressione',
                beschreibung: 'Con l\'evoluzione di forme di vita animale più complesse, sono emersi bisogni di indipendenza ed efficacia. Questo stadio ci spinge a plasmare attivamente il mondo — a sentirci, crescere ed esercitare influenza.',
                charakteristik: [
                    { sub: 'Capacità d\'azione, influenza, potere, sovranità' },
                    { sub: 'Autonomia, autodeterminazione, indipendenza' },
                    { sub: 'Vitalità, passione, auto-esperienza, sensualità' },
                    { sub: 'Crescita, sviluppo, apprendimento' }
                ],
                beziehung: 'Nelle relazioni, questo stadio si riflette come tensione tra vicinanza e libertà. Entrambi i partner hanno bisogno di spazio per lo sviluppo personale — mentre l\'intensità vissuta arricchisce la connessione comune.',
                frage: 'Dove vivi la tua forza — e dove ti trattieni?'
            },
            3: {
                titel: 'Connessione', evolution: 'Animali sociali',
                kernthema: 'Appartenenza & Risonanza',
                beschreibung: 'La vita sociale ha portato nuovi strati alla psiche: il bisogno di appartenenza, riconoscimento e connessione autentica. Questo livello è il nucleo emotivo della nostra capacità relazionale — qui si decide se ci sentiamo davvero visti.',
                charakteristik: [
                    { sub: 'Società, appartenenza, famiglia, clan' },
                    { sub: 'Apprezzamento, rispetto, importanza, utilità' },
                    { sub: 'Equità, proporzionalità, parità' },
                    { sub: 'Intimità, sicurezza, vicinanza, fiducia' }
                ],
                beziehung: 'Questo stadio è il cuore di ogni relazione amorosa. Il sentimento di essere davvero visti, ascoltati e accettati nutre il legame emotivo più profondamente di qualsiasi parola.',
                frage: 'Dove senti una connessione autentica — e dove sei solo/a interiormente?'
            },
            4: {
                titel: 'Senso', evolution: 'Vita (auto-)consapevole',
                kernthema: 'Significato & Autenticità',
                beschreibung: 'Lo stadio di sviluppo più elevato della psiche è emerso con l\'autoconsapevolezza. Qui non si tratta più solo di sopravvivenza o appartenenza — ma di chi siamo veramente e per cosa siamo qui. Conoscere questi bisogni è la chiave della maturità interiore.',
                charakteristik: [
                    { sub: 'Consapevolezza, riflessione, saggezza' },
                    { sub: 'Vocazione, visione, missione, significato' },
                    { sub: 'Veridicità, coerenza, autenticità, dignità' },
                    { sub: 'Diventare se stessi, autorealizzazione, fiorire' }
                ],
    ...
    synthese: {
        ...
        selectPartnerHintCompare: 'Seleziona un archetipo partner nella pagina principale per il confronto.',
        selectPartnerHintNeeds: 'Seleziona un archetipo partner nella pagina principale per vedere i bisogni condivisi.',
        selectPartnerHintPerspective: 'Seleziona un archetipo partner nella pagina principale per vedere prospettive, equilibrio testa-cuore e pro/contro.',
        selectPartnerHintRTI: 'Vengono mostrati solo i tuoi valori ICH. Seleziona un archetipo partner nella pagina principale per vedere il confronto.',

        title: 'Ti-Age Sintesi',
        compatibilityAnalysis: 'Analisi di compatibilità',
        scoreProContra: 'Punteggio – Pro & Contra',
        oshoZenTarot: 'Osho Zen Tarot',
        sharedNeeds: 'Bisogni condivisi',
        gfkAnalysis: 'Analisi dei bisogni CNV',
        needsMatchWithDiff: 'Corrispondenza bisogni con differenza',
        fivePillars: '5 Pilastri dell\'identità',
        rtiSubtitle: 'RTI secondo Petzold – Analisi dell\'attrito',
        baseArchetype: 'Archetipo base:',
        totalScore: 'Punteggio totale:',
        modifiersIncrease: 'I modificatori aumentano il punteggio di +{diff} punti percentuali',
        modifiersDecrease: 'I modificatori riducono il punteggio di {diff} punti percentuali',
        whatWorks: '✓ Cosa funziona',
        challengesLabel: '✗ Sfide',
        noDataAvailable: 'Nessun dato disponibile.',
        archetypeBaseValues: 'Valori base dell\'archetipo',
        archetypeBaseValuesDesc: 'Valori individualizzati non disponibili. Vengono mostrati i valori standard dell\'archetipo.',
        needsMatchLabel: 'Corrispondenza bisogni:',
        sharedCompatible: '✓ Bisogni condivisi & compatibili',
        challengingDiffs: '✗ Differenze sfidanti',
        sharedCount: '{count} bisogni condivisi & compatibili',
        diffCount: '{count} priorità differenti',
        noNeedsData: 'Nessun dato sui bisogni disponibile.',
        rtiNotAvailable: 'Calcolo RTI non disponibile (moduli mancanti).',
        identityHarmony: 'Armonia dell\'identità',
        rtiFullTitle: 'RTI secondo Petzold – 5 Pilastri dell\'identità',
        rtiExplanation: 'Ogni pilastro rappresenta un aspetto fondamentale dell\'identità umana. L\'attrito nasce quando i bisogni di un pilastro sono espressi in modo diverso.',
        highFriction: 'Alto attrito',
        mediumFriction: 'Attrito medio',
        perspectiveHints: 'Note prospettiche:',
        harmony: 'Armonia',
        dimensionScores: 'Punteggi dimensione (A-F)',
        pillarDesc: {
            S1: 'Corpo, Salute, Sessualità',
            S2: 'Tipo di relazione, Amici, Famiglia',
            S3: 'Autodeterminazione, Lavoro, Rendimento',
            S4: 'Stabilità, Finanze, Abitazione',
            S5: 'Spiritualità, Etica, Significato'
        },
        resonanzCoherence: 'Coerenza tra bisogni e archetipo',
        whatShowsTable: 'Cosa mostra questa tabella?',
        tipClickValue: 'Suggerimento: Clicca su un valore IO o PARTNER per vedere la derivazione completa!',
        manuallyLocked: 'Bloccato manualmente (modifica in Attributi)',
        autoCalculated: 'Calcolato automaticamente',
        multiplied: '→ moltiplicato',
        boostsScore: 'rafforza il punteggio',
        neutralLabel: 'neutro',
        weakensScore: 'indebolisce il punteggio',
        lockedNoChange: 'bloccato manualmente (non cambia al cambio di archetipo)',
        resonanzXperspektiven: 'FATTORI DI RISONANZA × PROSPETTIVE',
        weakensPercent: '−% indebolisce',
        factorLabels: { R1: 'Vita', R2: 'Filosofia', R3: 'Dinamica', R4: 'Identità' },
        factorDescs: {
            R1: 'Esistenza, Affetto, Svago, Intimità & Romanticismo',
            R2: 'Libertà, Partecipazione, Identità, Pianificazione, Finanze, Valori, Sociale, Pratico',
            R3: 'Dinamica, Sicurezza',
            R4: 'Comprensione, Creazione, Connessione, Comunicazione'
        },
        perspectives: {
            statistik: 'Statistica',
            statistikDesc: 'Bisogni fondamentali empiricamente provati',
            konditionierung: 'Condizionamento',
            konditionierungDesc: 'Bisogni naturali vs. appresi',
            qualitaet: 'Qualità',
            qualitaetDesc: 'Aspetti di qualità statici vs. dinamici',
            machtdynamik: 'Dinamiche di potere consapevoli e consenso'
        },
        oshoLoading: 'Il modulo Osho Zen si sta caricando...',
        oshoLoadingTexts: 'Caricamento testi Osho Zen...',
        oshoLoadingData: 'Caricamento dati Osho Zen...',
        oshoNoSharedNeeds: 'Nessun bisogno comune trovato.',
        oshoEnsureProfiles: 'Assicuratevi che entrambi i profili abbiano compilato i bisogni.',
        oshoTopNeeds: '🔥 I vostri Top {count} bisogni comuni',
        oshoBasedOn: 'Basato sulla corrispondenza dei vostri profili di bisogni',
        oshoNeedAlt: 'Bisogno {label}',
        oshoFooter: 'Questa sintesi combina concetti del modello RTI (5 pilastri dell\'identità secondo Hilarion Petzold), del modello a 4 livelli di Volker Schmidt, degli insegnamenti di Osho e della filosofia della qualità di Robert M. Pirsig. Tutti i diritti riservati ai rispettivi titolari.',
        ...
        // ── Pagina Panoramica ────────────────────────────────────────────────
        top5Title: 'Top-5 Bisogni',
        top5Subtitle: 'Clicca l\'immagine fino a 5 volte per saperne di più',
        breakdownSubtitle: 'Dettaglio bisogni',
        evolutionTitle: 'Forza evolutiva dei bisogni',
        evolutionSubtitleBoth: 'IO × PARTNER — Risonanza per stadio evolutivo',
        evolutionSubtitleIch: 'IO — Risonanza per stadio evolutivo',
        viewBild: '📷 Immagine', viewWeisheit: '📖 Saggezza', viewTradition: '🕊 Tradizioni',
        viewKarte: '🃏 Scheda bisogno', viewModif: '🔢 GAD G/A/D FFH',
        modifSectionTitle: '🔢 GAD G/A/D FFH · Modificatori',
        archetypbasis: 'Base archetipale', finalLabel: 'Finale', manualSurvey: 'Manuale / Sondaggio',
        modGeschlecht: 'Genere', modAttraktion: 'Attrazione', modDominanz: 'Dominanza',
        modOrientierung: 'Orientamento', modArchetyp: 'Archetipo',
        loadingKatalog: 'Caricamento del catalogo dei bisogni...',
        loadingWisdom: '🧬 Caricamento della saggezza Tiage...',
        noImage: 'Nessuna immagine disponibile', noWisdom: 'Nessun testo di saggezza disponibile',
        noTraditions: 'Nessuna fonte tradizionale disponibile', noTextAvailable: 'Nessun testo disponibile.',
        loadError: 'I testi non hanno potuto essere caricati.',
        noNeedsSaved: 'Nessun bisogno salvato.',
        noNeedsSavedHint: 'Imposta i bisogni nella pagina principale.',
        noModifiersActive: 'Nessun modificatore attivo.',
        noModifiersHint: 'Imposta Genere / Dominanza / Orientamento nella pagina principale.',
        reflexionLabel: '💡 Riflessione', standardBtn: '✓ Predefinito',
        imageSavedToast: 'Immagine salvata come predefinita ✓',
        setDefaultImgTitle: 'Imposta come immagine predefinita per questo bisogno',
        recalcToast: '↻ Ricalcolo dopo modifica dei bisogni',
        zoomHint: 'clicca per ingrandire', nextViewTitle: 'Vista successiva',
        closeBtnTitle: 'Chiudi', prevImgTitle: 'Precedente', nextImgTitle: 'Successivo',
        clickWisdomTitle: 'Clic: Mostra la saggezza Tiage',
        bestResonanceTitle: 'Migliore risonanza comune',
        biggestDiffTitle: 'Maggiore differenza con il partner',
        imagePrefSaved: 'Immagine predefinita salvata',
        notInTop5Title: 'Non nel vostro Top-5 comune',
        complementaryTitle: 'Complementare — non comune',
        complementaryDom: 'Dinamica complementare: Il dominante ha fortemente bisogno di questo — il sottomesso lo cede consapevolmente. Si completano.',
        complementarySub: 'Dinamica complementare: Il sottomesso ha fortemente bisogno di questo — il dominante lo soddisfa. Si completano.',
        deltaHighIch: 'Il tuo valore massimo è neutralizzato dalla differenza — la risonanza richiede una forza simile in entrambi.',
        deltaHighPartner: 'Il tuo partner priorizza questo più di te — la differenza è troppo grande per una vera risonanza.',
        bothTooLow: 'Entrambi prioritizzano questo bisogno troppo basso per il Top-5 comune.',
        tooDifferent: 'I valori sono troppo diversi per una vera priorità comune.',
        matrixHeaderFactor: 'Fattore-R → AGOD', matrixColKombi: 'IO × PARTNER',
        matrixClickTooltip: 'Clicca per aprire IO/{label} nelle impostazioni',
        breakdownInfo: '{n} bisogni regolati da G/A/D{ffh}{manual} · Clicca sul nome per i dettagli',
        breakdownColNeed: 'Bisogno', breakdownColStufe: 'Stadio',
        breakdownColBasis: 'Base', breakdownColFinal: 'Finale',
        breakdownDetailTitle: 'Dettagli per: {label}',
        breakdownManualTooltip: 'Deviazione manuale del cursore dal calcolo automatico',
        mobileTitle: 'PC Consigliato',
        mobileText1: 'Questa app è ottimizzata per l\'utilizzo su computer.',
        mobileText2: 'Non tutte le visualizzazioni funzionano perfettamente su mobile.',
        mobileContinue: 'Continua comunque',
        tradChristentum: 'Cristianesimo', tradBuddhismus: 'Buddhismo',
        tradIslam: 'Islam / Sufismo', tradOsho: 'Osho',
        tradModerne: 'Moderno', tradPirsig: 'Pirsig · Qualità',
        // ── Traduzioni aggiuntive ──────────────────────────────────────────
        oshoModuleHint: 'Assicurati che oshoZenTextGenerator.js sia caricato.',
        loadingKatalogShort: 'Caricamento catalogo...',
        noNeedsInStufe: 'Nessun bisogno trovato in questa fase',
        stufenSubtitleBoth: 'IO × PARTNER — intensità media dei bisogni per livello (0–100)',
        stufenSubtitleIch: 'TU — intensità dei bisogni per livello (0–100)',
        rtiVerbindung: 'Connessione RTI',
        staerksteBeduerfnisse: 'Bisogni più forti · {name}',
        deltaVeryHigh: 'molto al di sopra della media', deltaHigh: 'al di sopra della media',
        deltaVeryLow: 'molto al di sotto della media', deltaLow: 'al di sotto della media',
        deltaNormal: 'corrisponde alla norma archetipica',
        sourceManual: '🔒 Impostato manualmente da te',
        sourceCalculated: '📐 Calcolato dal profilo&#10;   ({name} + G · D · O · FFH · RTI)',
        viewWisheitHeader: '📖 Saggezza Ti-Age', viewTraditionHeader: '🕊 Tradizioni di saggezza',
        noTraditionsAvail: 'Nessuna tradizione disponibile',
        stufenDesc: { S1: 'Esistenza · Sicurezza · Riposo · Quotidiano', S2: 'Libertà · Espressione · Kink · Comunicazione', S3: 'Affetto · Intimità · Valori · Sociale', S4: 'Comprensione · Identità · Pianificazione di vita · Spiritualità' },
        stufenRtiDesc: { S1: 'Basato su Sicurezza & Struttura (S4)', S2: 'Alimentato da Corporalità (S1) e Autonomia (S3)', S3: 'Plasmato dalla Rete Sociale (S2)', S4: 'Sostenuto da Valori & Senso (S5) e Autonomia (S3)' },
        perspektivenTitle: 'Prospettive & Pro/Contro', perspektivenSubtitle: 'Confronto con il partner',
        perspektivenGewichtung: 'Ponderazione delle prospettive',
        perspektivenBlickwinkel: 'Punti di vista filosofici sui bisogni',
        kopfHerzBalance: 'Equilibrio testa-cuore', theorieVsPraxis: 'Teoria vs. Pratica',
        manuelleAenderungen: '{n} modifiche manuali',
        diskrepanz: 'Discrepanza', einklang: 'Armonia',
        theorie: 'Teoria', praxis: 'Pratica',
        automatischeBerechnung: 'Calcolo automatico',
        mitManuellenAenderungen: 'Con modifiche manuali',
        proContraTitle: 'Pro & Contro', proContraPaarung: 'Abbinamento',
        balanceInterpLocked0: 'Nessuna modifica manuale - Teoria = Pratica',
        balanceInterpVeryClose: 'Le modifiche manuali confermano la teoria',
        balanceInterpClose: 'Lieve scostamento per modifiche manuali',
        balanceInterpModerate: 'Scostamento moderato tra teoria e pratica',
        balanceInterpHigh: 'Discrepanza significativa - La pratica si discosta molto dalla teoria',
        balanceInterpNeutral: 'Le modifiche manuali si discostano un po\' dalla teoria',
        fallbackProCanLearn: '{ich} e {partner} possono imparare reciprocamente',
        fallbackProEnriching: 'Prospettive diverse arricchiscono la relazione',
        fallbackProGrowth: 'Potenziale di crescita reciproca',
        fallbackContraCommunication: 'Filosofie relazionali diverse richiedono comunicazione',
        fallbackContraExpectations: 'Gestione delle aspettative necessaria',
        fallbackContraCompromise: 'Disponibilità al compromesso richiesta da entrambe le parti',
        ichProfileNotLoaded: 'Profilo ICH non caricato',
        ichProfileNotLoadedHint: 'Assicurati che il profilo ICH sia completamente compilato.',
        hauptfragen: 'Domande principali Ti-Age', deineBeduerfnisse: 'I tuoi bisogni (IO)',
        hauptfragenSubtitle: 'Risonanza → Categorie → Sfumature',
        beduerfnisMatch: 'Corrispondenza dei bisogni',
        rtiSectionTitle: 'Pilastri RTI dell\'Identità', rtiSectionSubtitle: 'Secondo Hilarion Petzold',
        rtiInfoTitle: 'ℹ️ Cosa mostra questa analisi?',
        rtiInfoText: 'I 5 pilastri mostrano come i tuoi bisogni si allineano nelle aree più importanti della vita. Le barre confrontano i tuoi valori (IO) con quelli del tuo partner.',
        rtiInfoHighLabel: 'Alta Risonanza', rtiInfoHighMeaning: 'I vostri valori sono simili',
        rtiInfoLowLabel: 'Bassa Risonanza', rtiInfoLowMeaning: 'Qui potete imparare reciprocamente',
        resonanzLabel: 'Risonanza',
        resonanzHoch: 'Alta Risonanza', resonanzMittel: 'Risonanza Media', resonanzNiedrig: 'Bassa Risonanza',
        differenzPct: '{n}% di differenza', rtiModalTitle: 'Pilastri RTI',
        rtiPillars: {
            S1: { name: 'Corporalità', question: 'Quanto è importante la vicinanza fisica nella vostra relazione?', desc: 'Salute fisica, benessere, sessualità, movimento. Quanto mi sento a mio agio nel mio corpo?', interpHigh: 'Condividete un forte bisogno di connessione fisica.', interpMedium: 'Le vostre idee sulla vicinanza fisica differiscono in parte.', interpLow: 'È necessario un dialogo qui – le vostre esigenze sono diverse.' },
            S2: { name: 'Rete Sociale', question: 'Quanto è importante per voi essere integrati in un ambiente sociale?', desc: 'Famiglia, amici, colleghi, comunità. Quanto sono socialmente integrato/a e supportato/a?', interpHigh: 'Apprezzate entrambi una forte rete sociale.', interpMedium: 'Le vostre idee sull\'integrazione sociale variano.', interpLow: 'Aspettative diverse riguardo all\'integrazione sociale.' },
            S3: { name: 'Autonomia & Realizzazione', question: 'Quanto spazio personale è importante per voi?', desc: 'Lavoro, carriera, successo, autoefficacia. Quanto mi sento autodeterminato/a e competente?', interpHigh: 'Rispettate entrambi lo spazio personale dell\'altro.', interpMedium: 'L\'equilibrio tra vicinanza e autonomia è un tema da affrontare.', interpLow: 'Bisogni diversi di indipendenza.' },
            S4: { name: 'Sicurezza & Stabilità', question: 'Quanto sono importanti l\'affidabilità e la stabilità?', desc: 'Sicurezza materiale, abitazione, finanze, pianificazione del futuro. Quanto mi sento al sicuro?', interpHigh: 'Stabilità e affidabilità sono importanti per entrambi.', interpMedium: 'I vostri bisogni di sicurezza hanno pesi diversi.', interpLow: 'Dovreste parlare delle vostre aspettative qui.' },
            S5: { name: 'Valori & Significato', question: 'Condividete valori comuni e obiettivi di vita?', desc: 'Spiritualità, etica, senso della vita, visione del mondo. Cosa dà significato alla mia vita?', interpHigh: 'I vostri valori fondamentali e obiettivi di vita sono compatibili.', interpMedium: 'In alcune aree le vostre convinzioni differiscono.', interpLow: 'Diverse concezioni di valori richiedono comprensione.' }
        },
        rtiPillarInfo: {
            general: '<p>I cinque pilastri rappresentano i bisogni fondamentali che giocano un ruolo nelle relazioni. Si basano su modelli psicologici e rendono visibili le tue priorità.</p><p><strong>0 = Indifferente</strong> – questo argomento non riveste grande importanza per te<br><strong>1 = Normale</strong> – un bisogno di base, ma non al centro dell\'attenzione<br><strong>2 = Importante</strong> – qui si trova il tuo punto focale</p><p>Non c\'è un "giusto" o "sbagliato". I pilastri mostrano cosa conta per te – non cosa dovrebbe contare.</p>',
            S1: { text: '<p>Vicinanza fisica, tatto, sessualità. Quanto è importante per te l\'espressione fisica della connessione?</p><p>Questo comprende: presenza fisica, tenerezza, intimità sessuale, esperienza condivisa attraverso il corpo.</p>', quote: 'Pirsig direbbe: La qualità si rivela prima nel sentire, prima di essere pensata.' },
            S2: { text: '<p>Integrazione in un insieme più grande. Amici, famiglia, comunità. Quanto è importante per te che la tua relazione sia inserita in un ambiente sociale?</p><p>Questo comprende: amici in comune, integrazione familiare, visibilità pubblica della relazione, far parte di una comunità.</p>', quote: null },
            S3: { text: '<p>Indipendenza e spazio personale. Quanto è importante per te rimanere te stesso/a in una relazione?</p><p>Questo comprende: tempo personale, interessi personali, decisioni personali, spazio per lo sviluppo personale.</p>', quote: 'Osho dice: Due persone intere possono incontrarsi. Due metà cercano solo completamento.' },
            S4: { text: '<p>Stabilità, affidabilità, fiducia. Quanto è importante per te poter contare sulla relazione?</p><p>Questo comprende: sicurezza emotiva, impegno, costanza, accordi chiari.</p>', quote: null },
            S5: { text: '<p>Convinzioni condivise e obiettivi di vita. Quanto è importante per te concordare sulle questioni fondamentali?</p><p>Questo comprende: visione del mondo, concetto di vita, principi etici, orientamento spirituale o filosofico.</p>', quote: 'Prospettiva Tiage: La risonanza nasce non solo dal sentimento, ma anche dalla direzione condivisa.' }
        }
    },
    ...
    workflow: {
        ...
        step1: {
            ...
            philosophy: '„La qualità inizia con la conoscenza di sé. Chi sono io nell\'amore?" — Pirsig'
        },
        step2: {
            title: 'Definisci le tue Dimensioni',
            desc: 'Genere, orientamento sessuale e preferenza di dominanza formano il tuo profilo. Primario = vissuto, Secondario = interessato.',
            philosophy: '„Non sei il corpo, non sei la mente. Scopri chi sei al di là di tutte le etichette." — Osho'
        },
        step3: {
            title: 'Scegli l\'Archetipo del Partner',
            desc: 'Quale modello relazionale vive il tuo partner? Se non sei sicuro: prova diverse combinazioni.',
            philosophy: '„L\'altro non è un oggetto, ma uno specchio. Ciò che cerchi riflette ciò che sei." — Pirsig'
        },
        step4: {
            title: 'Definisci le Dimensioni del Partner',
            desc: 'Inserisci genere, orientamento e dominanza del tuo partner. Dati più precisi = risultati più precisi.',
            philosophy: '„Percepire senza giudicare è la più alta forma di intelligenza." — Osho'
        },
        step5: {
