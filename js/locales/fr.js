...
var TiageLocale_FR = {
    ...
    center: {
        ...
        gewichtungDesc: '0 = Ignorer · 1 = Pertinent · 2 = Important · 3 = Décisif',
        agodLabels: {
            A: 'ARCHÉTYPE',
            G: 'GENRE',
            O: 'ORIENTATION',
    ...
    beduerfnisKatalog: {
        heading: 'Stades de développement',
        stufen: {
            S1: { label: 'Fondation',    short: 'Fond.', desc: 'Existence · Sécurité · Repos · Quotidien' },
            S2: { label: 'Épanouissement', short: 'Épan.', desc: 'Liberté · Expression · Kink · Communication' },
            S3: { label: 'Connexion',    short: 'Conn.', desc: 'Affection · Intimité · Valeurs · Social' },
            S4: { label: 'Sens',         short: 'Sens',  desc: 'Identité · Planification de vie · Transformation' }
        },
        highStrength: 'Forte intensité du besoin à ce stade',
        mediumStrength: 'Intensité moyenne du besoin',
        lowStrength: 'Faible intensité du besoin à ce stade',
        avgLabel: 'Votre moy.',
        stufeLabel: 'Stade',
        kernthemaLabel: 'Thème central',
        charakteristikLabel: 'Besoins caractéristiques de ce stade',
        beziehungLabel: 'Dans votre relation',
        eureBeduerfnisseLabel: 'Vos besoins à ce stade',
        meineStaerkeLabel: 'Ma force',
        resonanzLabel: 'Résonance',
        geteiltLabel: 'partagé',
        needs: {
            wohlbefinden: 'Bien-être', sicherheit: 'Sécurité', leichtigkeit: 'Légèreté',
            orientierung: 'Orientation', wirksamkeit: 'Efficacité', freiheit: 'Liberté',
            intensitaet: 'Intensité', entwicklung: 'Développement', gemeinschaft: 'Communauté',
            anerkennung: 'Reconnaissance', gerechtigkeit: 'Justice', verbundenheit: 'Connexion',
            selbsterkenntnis: 'Connaissance de soi', sinn: 'Sens', integritaet: 'Intégrité',
            selbstentfaltung: 'Épanouissement personnel'
        },
        stufeInfo: {
            1: {
                titel: 'Fondation', evolution: 'Organismes pluricellulaires',
                kernthema: 'Sécurité & Stabilité',
                beschreibung: 'Le premier stade du développement psychique est apparu avec la vie multicellulaire. Il assure la survie par la coordination et la protection. Les besoins à ce niveau agissent profondément et souvent inconsciemment — leur non-satisfaction crée un stress persistant et un repli sur soi.',
                charakteristik: [
                    { sub: 'Intégrité, santé, forme physique, récupération' },
                    { sub: 'Confiance, stabilité, protection, loyauté' },
                    { sub: 'Conservation de l\'énergie, simplicité, harmonie' },
                    { sub: 'Clarté, structure, ordre, direction, contrôle' }
                ],
                beziehung: 'Dans les relations, ce stade se manifeste par le désir de fiabilité, d\'accords clairs et de sécurité émotionnelle. Un manque à ce niveau entraîne de l\'anxiété, un retrait ou un contrôle excessif.',
                frage: 'Où vous sentez-vous vraiment en sécurité — et où non ?'
            },
            2: {
                titel: 'Épanouissement', evolution: 'Vie animale',
                kernthema: 'Force & Expression de soi',
                beschreibung: 'Avec l\'évolution de formes de vie animale plus complexes, des besoins d\'indépendance et d\'efficacité ont émergé. Ce stade nous pousse à façonner activement le monde — à nous ressentir, grandir et exercer une influence.',
                charakteristik: [
                    { sub: 'Capacité d\'action, influence, pouvoir, souveraineté' },
                    { sub: 'Autonomie, autodétermination, indépendance' },
                    { sub: 'Vitalité, passion, expérience de soi, sensualité' },
                    { sub: 'Croissance, épanouissement, apprentissage' }
                ],
                beziehung: 'Dans les relations, ce stade se reflète comme une tension entre proximité et liberté. Les deux partenaires ont besoin d\'espace pour se développer — tandis que l\'intensité vécue enrichit la connexion commune.',
                frage: 'Où vivez-vous votre force — et où vous retenez-vous ?'
            },
            3: {
                titel: 'Connexion', evolution: 'Animaux sociaux',
                kernthema: 'Appartenance & Résonance',
                beschreibung: 'La vie sociale a apporté de nouvelles couches à la psyché : le besoin d\'appartenance, de reconnaissance et de connexion authentique. Ce niveau est le cœur émotionnel de notre capacité relationnelle — c\'est ici que se décide si nous nous sentons vraiment vus.',
                charakteristik: [
                    { sub: 'Société, appartenance, famille, clan' },
                    { sub: 'Appréciation, respect, importance, utilité' },
                    { sub: 'Équité, proportionnalité, égalité' },
                    { sub: 'Intimité, sécurité, proximité, confiance' }
                ],
                beziehung: 'Ce stade est le cœur de toute relation amoureuse. Le sentiment d\'être vraiment vu, entendu et accepté nourrit le lien émotionnel plus profondément que tous les mots.',
                frage: 'Où ressentez-vous une connexion authentique — et où êtes-vous seul(e) intérieurement ?'
            },
            4: {
                titel: 'Sens', evolution: 'Vie (auto-)consciente',
                kernthema: 'Signification & Authenticité',
                beschreibung: 'Le stade de développement le plus élevé de la psyché est apparu avec la conscience de soi. Il ne s\'agit plus seulement de survie ou d\'appartenance — mais de qui nous sommes vraiment et pourquoi nous sommes ici. Connaître ces besoins est la clé de la maturité intérieure.',
                charakteristik: [
                    { sub: 'Conscience, réflexion, sagesse' },
                    { sub: 'Vocation, vision, mission, signification' },
                    { sub: 'Véracité, cohérence, authenticité, dignité' },
                    { sub: 'Devenir soi, réalisation de soi, épanouissement' }
                ],
    ...
    synthese: {
        ...
        oshoFooter: 'Cette synthèse combine des concepts du modèle RTI (5 piliers de l\'identité selon Hilarion Petzold), du modèle à 4 niveaux de Volker Schmidt, des enseignements d\'Osho et de la philosophie de la qualité de Robert M. Pirsig. Tous droits réservés aux détenteurs respectifs.',
        ...
        // ── Page Vue d'ensemble ─────────────────────────────────────────────
        top5Title: 'Top-5 Besoins',
        top5Subtitle: 'Cliquez jusqu\'à 5 fois sur l\'image pour en savoir plus',
        breakdownSubtitle: 'Détail des besoins',
        evolutionTitle: 'Force évolutive des besoins',
        evolutionSubtitleBoth: 'MOI × PARTENAIRE — Résonance par stade d\'évolution',
        evolutionSubtitleIch: 'MOI — Résonance par stade d\'évolution',
        viewBild: '📷 Image', viewWeisheit: '📖 Sagesse', viewTradition: '🕊 Traditions',
        viewKarte: '🃏 Carte des besoins', viewModif: '🔢 GAD G/A/D FFH',
        modifSectionTitle: '🔢 GAD G/A/D FFH · Modificateurs',
        archetypbasis: 'Base d\'archétype', finalLabel: 'Final', manualSurvey: 'Manuel / Enquête',
        modGeschlecht: 'Genre', modAttraktion: 'Attraction', modDominanz: 'Dominance',
        modOrientierung: 'Orientation', modArchetyp: 'Archétype',
        loadingKatalog: 'Chargement du catalogue des besoins...',
        loadingWisdom: '🧬 Chargement de la sagesse Tiage...',
        noImage: 'Aucune image disponible', noWisdom: 'Aucun texte de sagesse disponible',
        noTraditions: 'Aucune source traditionnelle disponible', noTextAvailable: 'Aucun texte disponible.',
        loadError: 'Les textes n\'ont pas pu être chargés.',
        noNeedsSaved: 'Aucun besoin enregistré.',
        noNeedsSavedHint: 'Veuillez définir vos besoins sur la page principale.',
        noModifiersActive: 'Aucun modificateur actif.',
        noModifiersHint: 'Définissez Genre / Dominance / Orientation sur la page principale.',
        reflexionLabel: '💡 Réflexion', standardBtn: '✓ Par défaut',
        imageSavedToast: 'Image enregistrée par défaut ✓',
        setDefaultImgTitle: 'Définir comme image par défaut pour ce besoin',
        recalcToast: '↻ Recalcul après modification des besoins',
        zoomHint: 'cliquer pour agrandir', nextViewTitle: 'Vue suivante',
        closeBtnTitle: 'Fermer', prevImgTitle: 'Précédent', nextImgTitle: 'Suivant',
        clickWisdomTitle: 'Clic : Afficher la sagesse Tiage',
        bestResonanceTitle: 'Meilleure résonance commune',
        biggestDiffTitle: 'Plus grande différence avec le partenaire',
        imagePrefSaved: 'Image par défaut enregistrée',
        notInTop5Title: 'Pas dans votre Top-5 commun',
        complementaryTitle: 'Complémentaire — pas commun',
        complementaryDom: 'Dynamique complémentaire : Le dominant a fortement besoin de cela — le soumis le libère consciemment. Ils se complètent.',
        complementarySub: 'Dynamique complémentaire : Le soumis a fortement besoin de cela — le dominant le comble. Ils se complètent.',
        deltaHighIch: 'Votre valeur maximale est neutralisée par la différence — la résonance nécessite une force similaire chez les deux.',
        deltaHighPartner: 'Votre partenaire priorise cela plus que vous — la différence est trop grande pour une vraie résonance.',
        bothTooLow: 'Les deux priorisent ce besoin trop bas pour le Top-5 commun.',
        tooDifferent: 'Les valeurs sont trop différentes pour une vraie priorité commune.',
        matrixHeaderFactor: 'Facteur-R → AGOD', matrixColKombi: 'MOI × PARTENAIRE',
        matrixClickTooltip: 'Cliquer pour ouvrir MOI/{label} dans les paramètres',
        breakdownInfo: '{n} besoins ajustés par G/A/D{ffh}{manual} · Cliquer sur le nom pour les détails',
        breakdownColNeed: 'Besoin', breakdownColStufe: 'Stade',
        breakdownColBasis: 'Base', breakdownColFinal: 'Final',
        breakdownDetailTitle: 'Détails pour : {label}',
        breakdownManualTooltip: 'Déviation manuelle du curseur par rapport au calcul automatique',
        mobileTitle: 'PC Recommandé',
        mobileText1: 'Cette application est optimisée pour une utilisation sur ordinateur.',
        mobileText2: 'Toutes les vues ne fonctionnent pas parfaitement sur mobile.',
        mobileContinue: 'Continuer quand même',
        tradChristentum: 'Christianisme', tradBuddhismus: 'Bouddhisme',
        tradIslam: 'Islam / Soufisme', tradOsho: 'Osho',
        tradModerne: 'Moderne', tradPirsig: 'Pirsig · Qualité',
        // ── Traductions supplémentaires ────────────────────────────────────
        oshoModuleHint: 'Veuillez vous assurer que oshoZenTextGenerator.js est chargé.',
        loadingKatalogShort: 'Chargement du catalogue...',
        noNeedsInStufe: 'Aucun besoin trouvé à ce stade',
        stufenSubtitleBoth: 'MOI × PARTENAIRE — force moy. des besoins par étape (0–100)',
        stufenSubtitleIch: 'TOI — force des besoins par étape (0–100)',
        rtiVerbindung: 'Connexion RTI',
        staerksteBeduerfnisse: 'Besoins les plus forts · {name}',
        deltaVeryHigh: 'très au-dessus de la moyenne', deltaHigh: 'au-dessus de la moyenne',
        deltaVeryLow: 'très en dessous de la moyenne', deltaLow: 'en dessous de la moyenne',
        deltaNormal: 'correspond à la norme archétypale',
        sourceManual: '🔒 Défini manuellement par toi',
        sourceCalculated: '📐 Calculé depuis le profil&#10;   ({name} + G · D · O · FFH · RTI)',
        viewWisheitHeader: '📖 Sagesse Ti-Age', viewTraditionHeader: '🕊 Traditions de sagesse',
        noTraditionsAvail: 'Aucune tradition disponible',
        stufenDesc: { S1: 'Existence · Sécurité · Repos · Quotidien', S2: 'Liberté · Expression · Kink · Communication', S3: 'Affection · Intimité · Valeurs · Social', S4: 'Compréhension · Identité · Planification de vie · Spiritualité' },
        stufenRtiDesc: { S1: 'Basé sur Sécurité & Structure (S4)', S2: 'Nourri par Corporéité (S1) et Autonomie (S3)', S3: 'Façonné par le Réseau Social (S2)', S4: 'Porté par Valeurs & Sens (S5) et Autonomie (S3)' },
        perspektivenTitle: 'Perspectives & Pour/Contre', perspektivenSubtitle: 'Comparaison avec le partenaire',
        perspektivenGewichtung: 'Pondération des perspectives',
        perspektivenBlickwinkel: 'Points de vue philosophiques sur les besoins',
        kopfHerzBalance: 'Équilibre tête-cœur', theorieVsPraxis: 'Théorie vs. Pratique',
        manuelleAenderungen: '{n} modifications manuelles',
        diskrepanz: 'Divergence', einklang: 'Harmonie',
        theorie: 'Théorie', praxis: 'Pratique',
        automatischeBerechnung: 'Calcul automatique',
        mitManuellenAenderungen: 'Avec modifications manuelles',
        proContraTitle: 'Pour & Contre', proContraPaarung: 'Appariement',
        balanceInterpLocked0: 'Aucune modification manuelle - Théorie = Pratique',
        balanceInterpVeryClose: 'Les ajustements manuels confirment la théorie',
        balanceInterpClose: 'Faible écart dû aux ajustements manuels',
        balanceInterpModerate: 'Écart modéré entre théorie et pratique',
        balanceInterpHigh: 'Divergence importante - La pratique s\'écarte fortement de la théorie',
        balanceInterpNeutral: 'Les ajustements manuels s\'écartent légèrement de la théorie',
        fallbackProCanLearn: '{ich} et {partner} peuvent apprendre mutuellement',
        fallbackProEnriching: 'Des perspectives différentes enrichissent la relation',
        fallbackProGrowth: 'Potentiel de croissance mutuelle',
        fallbackContraCommunication: 'Des philosophies relationnelles différentes nécessitent de la communication',
        fallbackContraExpectations: 'Gestion des attentes nécessaire',
        fallbackContraCompromise: 'Volonté de compromis requise des deux côtés',
        ichProfileNotLoaded: 'Profil ICH non chargé',
        ichProfileNotLoadedHint: 'Veuillez vous assurer que le profil ICH est complètement rempli.',
        hauptfragen: 'Questions principales Ti-Age', deineBeduerfnisse: 'Tes besoins (MOI)',
        hauptfragenSubtitle: 'Résonance → Catégories → Nuances',
        beduerfnisMatch: 'Correspondance des besoins',
        rtiSectionTitle: 'Piliers RTI de l\'Identité', rtiSectionSubtitle: 'D\'après Hilarion Petzold',
        rtiInfoTitle: 'ℹ️ Que montre cette analyse?',
        rtiInfoText: 'Les 5 piliers montrent comment vos besoins s\'alignent dans les domaines les plus importants de la vie. Les barres comparent tes valeurs (MOI) avec celles de ton partenaire.',
        rtiInfoHighLabel: 'Haute Résonance', rtiInfoHighMeaning: 'Vos valeurs sont similaires',
        rtiInfoLowLabel: 'Basse Résonance', rtiInfoLowMeaning: 'Ici vous pouvez apprendre mutuellement',
        resonanzLabel: 'Résonance',
        resonanzHoch: 'Haute Résonance', resonanzMittel: 'Résonance Moyenne', resonanzNiedrig: 'Basse Résonance',
        differenzPct: '{n}% de différence', rtiModalTitle: 'Piliers RTI',
        rtiPillars: {
            S1: { name: 'Corporéité', question: 'Quelle importance accordes-tu à la proximité physique dans ta relation?', desc: 'Santé physique, bien-être, sexualité, mouvement. Dans quelle mesure me sens-je bien dans mon corps?', interpHigh: 'Vous partagez un fort besoin de connexion physique.', interpMedium: 'Vos conceptions de la proximité physique diffèrent en partie.', interpLow: 'Une discussion s\'impose ici – vos besoins sont différents.' },
            S2: { name: 'Réseau Social', question: 'Quelle importance accordes-tu à ton intégration dans un environnement social?', desc: 'Famille, amis, collègues, communauté. Dans quelle mesure suis-je socialement intégré(e) et soutenu(e)?', interpHigh: 'Vous appréciez tous deux un solide réseau social.', interpMedium: 'Vos conceptions de l\'intégration sociale varient.', interpLow: 'Des attentes différentes en matière d\'intégration sociale.' },
            S3: { name: 'Autonomie & Accomplissement', question: 'Quelle importance accordes-tu à ton espace personnel?', desc: 'Travail, carrière, succès, auto-efficacité. Dans quelle mesure me sens-je autodéterminé(e) et compétent(e)?', interpHigh: 'Vous respectez tous deux l\'espace personnel de l\'autre.', interpMedium: 'L\'équilibre entre proximité et autonomie est un sujet à aborder.', interpLow: 'Des besoins différents en matière d\'indépendance.' },
            S4: { name: 'Sécurité & Stabilité', question: 'Quelle importance accordes-tu à la fiabilité et à la stabilité?', desc: 'Sécurité matérielle, logement, finances, planification de l\'avenir. Dans quelle mesure me sens-je en sécurité?', interpHigh: 'La stabilité et la fiabilité sont importantes pour vous deux.', interpMedium: 'Vos besoins de sécurité sont pondérés différemment.', interpLow: 'Vous devriez parler de vos attentes ici.' },
            S5: { name: 'Valeurs & Sens', question: 'Partagez-vous des valeurs communes et des objectifs de vie?', desc: 'Spiritualité, éthique, sens de la vie, vision du monde. Qu\'est-ce qui donne du sens à ma vie?', interpHigh: 'Vos valeurs fondamentales et vos objectifs de vie sont compatibles.', interpMedium: 'Dans certains domaines, vos convictions diffèrent.', interpLow: 'Des conceptions de valeurs différentes exigent de la compréhension.' }
        },
        rtiPillarInfo: {
            general: '<p>Les cinq piliers représentent les besoins fondamentaux qui jouent un rôle dans les relations. Ils sont basés sur des modèles psychologiques et rendent visibles tes priorités.</p><p><strong>0 = Indifférent</strong> – ce sujet ne joue pas un grand rôle pour toi<br><strong>1 = Normal</strong> – un besoin de base, mais pas au premier plan<br><strong>2 = Important</strong> – voici ton centre d\'intérêt</p><p>Il n\'existe pas de "juste" ou "faux". Les piliers montrent ce qui compte pour toi – pas ce qui devrait compter.</p>',
            S1: { text: '<p>Proximité physique, toucher, sexualité. Quelle importance accordes-tu à l\'expression physique de la connexion?</p><p>Cela comprend: présence physique, tendresse, intimité sexuelle, expérience partagée à travers le corps.</p>', quote: 'Pirsig dirait: La qualité se manifeste d\'abord dans le ressenti, avant d\'être pensée.' },
            S2: { text: '<p>Intégration dans un tout plus grand. Amis, famille, communauté. Quelle importance accordes-tu à ce que ta relation soit ancrée dans un environnement social?</p><p>Cela comprend: amis communs, intégration familiale, visibilité publique de la relation, appartenance à une communauté.</p>', quote: null },
            S3: { text: '<p>Indépendance et espace personnel. Quelle importance accordes-tu à rester toi-même dans une relation?</p><p>Cela comprend: temps personnel, intérêts personnels, décisions personnelles, espace pour le développement personnel.</p>', quote: 'Osho dit: Deux êtres entiers peuvent se rencontrer. Deux moitiés ne cherchent que la complétude.' },
            S4: { text: '<p>Stabilité, fiabilité, confiance. Quelle importance accordes-tu au sentiment de pouvoir compter sur la relation?</p><p>Cela comprend: sécurité émotionnelle, engagement, constance, accords clairs.</p>', quote: null },
            S5: { text: '<p>Convictions partagées et objectifs de vie. Quelle importance accordes-tu à être en accord sur les questions fondamentales?</p><p>Cela comprend: vision du monde, conception de la vie, principes éthiques, orientation spirituelle ou philosophique.</p>', quote: 'Perspective Tiage: La résonance naît non seulement du sentiment, mais aussi d\'une direction commune.' }
        }
    },
