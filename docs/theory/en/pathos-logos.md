...
- Single ↔ Polyamorous = low match
- Duo ↔ Duo-Flex = high match
...
- **Static Quality (Logos):** Structured, repeatable patterns
- **Dynamic Quality (Pathos):** Creative force for growth

### OSHO: Awareness and Polarity

> *"Only extremes can truly attract each other."*

> *"Tao - one energy, two expressions."*

## The Balance Calculation

In the resonance factor, the relationship between Logos and Pathos is measured:

```
Logos = A (Archetype Score)
Pathos = (O + D + G) / 3

Balance (B) = (100 - |Logos - Pathos|) / 100
```
...
- Average O, D, G: 65%
- Difference: |72 - 65| = 7
- Balance: (100 - 7) / 100 = **0.93**

A high balance (close to 1.0) means: Head and heart are in harmony.
...
4. **Relationships primarily work through feelings** - Logic alone doesn't create attraction

## Further Documentation

- [Pirsig Philosophy](pirsig.md) - Static and dynamic quality in detail
- [OSHO Philosophy](osho.md) - Polarity and awareness
- [Resonance Theory](resonance.md) - How Logos and Pathos work together
