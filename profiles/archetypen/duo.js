...
const DuoProfil = {
    ...
    // Diese Bedürfnisse sind archetyp-spezifisch und noch nicht im SSOT
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    erweitert: {
        ...
        intimitaet_romantik: {
            hand_halten: 85,
            romantische_gesten: 85,
            ueberraschungen: 75,
            dates: 80,
            alltags_romantik: 85,
            aufmerksamkeiten: 85,
            liebesbekundungen: 90,
            sexuelle_haeufigkeit: 80,
            sexuelle_intimiaet: 90,
            koerperliche_lust: 75,
            sexuelle_experimentierfreude: 55,
            sexuelle_verbindung: 90,
            sexuelle_zufriedenheit: 85,
            // Pirsig & Osho
            biologische_anziehung: 75,
            intellektuelle_verbindung: 70,
            qualitaet_der_beruehrung: 85,
            dynamische_liebe: 65,
            care_in_intimitaet: 85,
            sex_als_meditation: 45,
            liebe_ohne_beziehung: 10,
            orgastisches_leben: 50,
            nicht_anhaften_an_partner: 10,
            hier_und_jetzt_intimitaet: 60,
            polyamore_energie: 5,
            wildheit_und_zartheit: 55,
            meditation_zu_zweit: 50
        },
        ...
        werte_haltung: {
            spiritualitaet: 55,
            glaubenspraxis: 50,
            religioese_gemeinschaft: 55,
            saekularitaet: 50,
            sinnsuche: 65,
            transzendenz: 55,
            traditionelle_werte: 75,
            moderne_lebensweise: 45,
            konservative_werte: 65,
            progressive_werte: 45,
            kulturelle_tradition: 70,
            offenheit_fuer_neues: 45,
            umweltverantwortung: 55,
            nachhaltigkeit: 55,
            oekologisches_bewusstsein: 50,
            pragmatismus: 65,
            klimaschutz: 50,
            ressourcenschonung: 55,
            // Pirsig & Osho
            qualitaet_als_gott: 60,
            rationaler_mystizismus: 45,
            aristotelische_vernunft: 65,
            platonische_ideen: 55,
            buddhistische_achtsamkeit: 55,
            religionslosigkeit: 25,
            eigene_wahrheit: 40,
            zen_paradox: 25,
            tantra_als_weg: 30,
            politische_rebellion: 20,
            individueller_anarchismus: 15,
            leben_als_kunst: 50,
            celebration_statt_gebet: 45
        },
        ...
        praktisches_leben: {
            ...
            chaos_toleranz: 40,
            organisiert_sein: 70,
            flexibilitaet_haushalt: 50,
            reisen: 55,
            abenteuer: 40,
            neue_orte_entdecken: 50,
            zuhause_bleiben: 80,
            urlaub: 70,
            fernweh: 35,
            heimatverbundenheit: 85,
            // Pirsig & Osho
            motorrad_pflege: 50,
            gumption_im_alltag: 60,
            stuck_vermeiden: 50,
            klassische_ordnung: 75,
            romantisches_chaos: 35,
            qualitaets_werkzeug: 60,
            achtsamkeit_im_detail: 70,
            meditation_im_alltag: 45,
            gesundheit_durch_bewusstsein: 50,
            dynamische_meditation: 30,
            vipassana_im_leben: 40,
            natuerliches_leben: 55,
            lachen_therapie: 60,
            no_mind: 30,
            zorba_der_geniesser: 60
        }
    },
